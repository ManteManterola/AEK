            ...
            <div>
                ...
                <div class="row">
                    ...
                    <c:if test="${msg=='insertOk'}">
                        <div class="alert alert-success alert-dismissible fade show m-0" role="alert">
                            <strong>Ok!</strong> Curso creado correctamente.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </c:if>
                    ...
                    <c:if test="${msg=='insertError'}">
                        <div class="alert alert-danger alert-dismissible fade show m-0" role="alert">
                            <strong>Error:</strong> No se pudo crear el curso.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </c:if>
                    ...
                    <c:if test="${msg=='editOk'}">
                        <div class="alert alert-success alert-dismissible fade show m-0" role="alert">
                            <strong>Ok!</strong> Curso editado correctamente.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </c:if>
                    ...
                    <aside class="col-2 text-center bg-dark">
                        ...
                        <ul class="list-group">
                            ...
                            <a href="IndexCursos">
                                <li class="list-group-item activo"><span class="desaparece">Cursos</span>
                    ...
                    <div class="col-10 mt-2">
                        ...
                        <div class="modal fade" id="crearCurso" tabindex="-1" aria-labelledby="createModalLabel"
                            aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="StoreCursos" method="post">
                                            ...
                                            <p>
                                                Profesor: <select name="idProfesor">
                                                    <option value="0"></option>
                                                    <c:forEach items="${profesores}" var="profesores">
                                                        <option value="${profesores.id}">${profesores.dni}
                                                            | ${profesores.nombre} ${profesores.apellido}</option>
                                                    </c:forEach>
                                                </select>
                                            </p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-light" data-bs-toggle="modal"
                                                data-bs-target="#verCurso${curso.id}">
                                            ...
                                            <div class="modal fade" id="verCurso${curso.id}" tabindex="-1"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <ul class="list-group list-group-flush">
                                                                ...
                                                                <li class="list-group-item"><strong>Nivel:</strong>
                                                                    ${curso.nivel}</li>
                                                                <li class="list-group-item"><strong>Turno:</strong>
                                                                    ${curso.turno}</li>
                                                                <li class="list-group-item"><strong>Profesor:</strong>
                                                                    ${curso.profesor.dni} | ${curso.profesor.nombre}
                                                                    ${curso.profesor.apellido}</li>
                                            ...
                                            <button type="button" class="btn btn-light" data-bs-toggle="modal"
                                                data-bs-target="#editarCurso${curso.id}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                            ...
                                            <div class="modal fade" id="editarCurso${curso.id}" tabindex="-1"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="UpdateCursos" method="POST">
                                                                ...
                                                                <select name="nivel">
                                                                    <option value="A1" ${curso.nivel=='A1' ? 'selected'
                                                                        : '' }>A1</option>
                                                                    <option value="A2" ${curso.nivel=='A2' ? 'selected'
                                                                        : '' }>A2</option>
                                                                    <option value="B1" ${curso.nivel=='B1' ? 'selected'
                                                                        : '' }>B1</option>

                                                                    <option value="B2" ${curso.nivel=='B2' ? 'selected'
                                                                        : '' }>B2</option>
                                                                    <option value="C1" ${curso.nivel=='C1' ? 'selected'
                                                                        : '' }>C1</option>
                                                                    <option value="C2" ${curso.nivel=='C2' ? 'selected'
                                                                        : '' }>C2</option>
                                                                </select>
                                                                ...
                                                                <select name="turno">
                                                                    <option value="Diurno" ${curso.turno=='Diurno'
                                                                        ? 'selected' : '' }>Diurno</option>
                                                                    <option value="Vespertino"
                                                                        ${curso.turno=='Vespertino' ? 'selected' : '' }>
                                                                        Vespertino</option>
                                                                    <option value="Nocturno" ${curso.turno=='Nocturno'
                                                                        ? 'selected' : '' }>Nocturno</option>
                                                                </select>


                                                                <p class="mb-0">
                                                                    Profesor :<br> <select name="idProfesor">
                                                                        <c:forEach items="${profesores}"
                                                                            var="profesores">
                                                                            <option ${profesores.id==curso.profesor.id
                                                                                ? 'selected' : '' }
                                                                                value="${profesores.id}">
                                                                                ${profesores.dni}|
                                                                                ${profesores.nombre}
                                                ...
                                                href="DestroyCursos?id=${curso.id}"><svg
