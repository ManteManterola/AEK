                        ...
                        <c:forEach items="${cursos}" var="curso">
                            <tr>
                                ...
                                <td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <ul class="list-group list-group-flush">
 														 ...
 														 <li class="list-group-item"><strong>Nivel:</strong> ${curso.nivel}</li>
 														 <li class="list-group-item"><strong>Turno:</strong> ${curso.turno}</li>
 														  <li class="list-group-item"><strong>Profesor:</strong> ${curso.profesor.dni} | ${curso.profesor.nombre} ${curso.profesor.apellido}</li>
									...
									<!-- boton eliminar -->
                                    <a class="btn btn-light" href="DestroyCursos?id=${curso.id}"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                                            height="25" fill="currentColor" class="bi bi-backspace-reverse"
                                            viewBox="0 0 16 16">
                                            <path
