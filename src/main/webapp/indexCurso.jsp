	...
	<div>
		...
		<div class="row">
			...
			<c:if test="${msg=='insertError'}">
				<div class="alert alert-danger alert-dismissible fade show m-0"
					role="alert">
					<strong>Error:</strong> Este curso ya existe
					<button type="button" class="btn-close" data-bs-dismiss="alert"
						aria-label="Close"></button>
				</div>
			</c:if>
							...
							<tr>
								...
								<td>
									...
									<button type="button" class="btn btn-light"
										data-bs-toggle="modal" data-bs-target="#verCurso${curso.id}">
									...
									<div class="modal fade" id="editarCurso${curso.id}"
													...
													<form action="UpdateCursos" method="POST">
														...
														<p class="mb-0">
															Profesor :<br> <select name="idProfesor">
																...
																<c:forEach items="${profesores}" var="profesores">
																	<option
																		${profesores.id==curso.profesor.id ? 'selected': '' }
																		value="${profesores.id}">${profesores.dni}|
																		${profesores.nombre} ${profesores.apellido}</option>
																</c:forEach>
															</select>
														</p>
