	...
	<div>
		...
		<c:if test="${msg=='insertOk'}">
			<div class="alert alert-success alert-dismissible fade show m-0"
				role="alert">
				<strong>Ok!</strong> Profesor creado correctamente.
		...
		<c:if test="${msg=='errorDniRepetidoInsert'}">
			<div class="alert alert-danger alert-dismissible fade show m-0"
				role="alert">
				<strong>Error:</strong> El DNI ya existe en la base de datos.
				<button type="button" class="btn-close" data-bs-dismiss="alert"
					aria-label="Close"></button>
			</div>
		</c:if>
		...
		<c:if test="${msg=='deleteOk'}">
			<div class="alert alert-success alert-dismissible fade show m-0"
				role="alert">
				<strong>Ok!</strong> El profesor se elimino correctamente.
				<button type="button" class="btn-close" data-bs-dismiss="alert"
					aria-label="Close"></button>
			</div>
		</c:if>
		...
		<c:if test="${msg=='editOk'}">
			<div class="alert alert-success alert-dismissible fade show m-0"
				role="alert">
				<strong>Ok!</strong> Profesor editado correctamente.
				<button type="button" class="btn-close" data-bs-dismiss="alert"
					aria-label="Close"></button>
			</div>
		</c:if>
		...
		<div class="row">
			...
			<aside class="col-2 text-center bg-dark">
				...
				<ul class="list-group">
					<a href="IndexProfesores">
						<li class="list-group-item activo"><span class="desaparece">Profesores</span>
			...
			<div class="col-10 mt-2 ">
				...
				<div class="modal fade" id="crearProfesor" tabindex="-1"
						...
						<c:forEach items="${profesores}" var="profesor">
							<tr>
								...
								<td>
									...
									<div class="modal fade" id="verProfesor${profesor.id}"
									...
									<div class="modal fade" id="editarModal${profesor.id}"
										tabindex="-1" aria-labelledby="exampleModalLabel"
										aria-hidden="true">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="UpdateProfesores" method="POST">
														...
														<p class="mb-0">DNI:</p>
														<input type="text" name="dni" value="${profesor.dni}" />
									...
									href="DestroyProfesores?id=${profesor.id}"><svg
