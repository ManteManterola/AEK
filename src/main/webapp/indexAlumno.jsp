            ...
            <div>
                ...
                <div class="row">
                    ...
                    <c:if test="${msg=='errorFormatoDniInsert'}">
                        <div class="alert alert-danger alert-dismissible fade show m-0" role="alert">
                            <strong>Error:</strong> El formato del DNI es incorrecto. El formato correcto es
                            <strong>"12345678A"</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </c:if>
                    ...
                    <c:if test="${msg=='errorFormatoDniEdit'}">
                        <div class="alert alert-danger alert-dismissible fade show m-0" role="alert">
                            <strong>Error:</strong> El formato del DNI que estas editando es incorrecto.El formato
                                                                ...
                                                                <p>
                                                                    ...
                                                                    <select name="idCurso">
                                                                        ...
                                                                        <c:forEach items="${cursos}" var="cursos">
                                                                            <option ${cursos.id==alumno.curso.id
                                                                                ? 'selected' : '' }
