                ...
                <div class="row">
                    ...
                    <c:if test="${msg=='insertOk'}">
                        <div class="alert alert-success alert-dismissible fade show m-0" role="alert">
                            <strong>Ok!</strong> Programa creado correctamente.
                    ...
                    <c:if test="${msg=='editOk'}">
                        <div class="alert alert-success alert-dismissible fade show m-0" role="alert">
                            <strong>Ok!</strong> Programa editado correctamente.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </c:if>
                    ...
                    <div class="col-10 mt-2">
                        ...
                        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#crearPrograma">
                                                ...
                                                <select name="idCurso">
                                                    ...
                                                    <c:forEach items="${cursosSinPrograma}" var="cursosSinPrograma">
                                                        <option value="${cursosSinPrograma.id}">
                                                            ${cursosSinPrograma.nivel} ${cursosSinPrograma.turno}
                                                        </option>
                                                    </c:forEach>
                                                </select>
                                            </p>
                                ...
                                <c:forEach items="${programas}" var="programa">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="verCriterioEvaluacion${programa.curso.id}"
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="modificarPrograma${programa.curso.id}"
                                                tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form action="UpdateProgramas" method="post">
                                                                <input type="hidden" name="idCurso"
                                                                    value="${programa.curso.id}" />
                                                                <h5>Contenido:</h5>
                                                                <textarea name="contenido" rows="4"
                                                                    cols="50">${programa.contenido}</textarea>
                                                                <h5>Criterios de evaluacion:</h5>
                                                                <textarea name="criterioEvaluacion" rows="4"
                                                                    cols="50">${programa.criterioEvaluacion}</textarea>
