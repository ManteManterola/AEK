    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-10 mt-2">
                ...
                <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#crearPrograma">
                ...
                <div class="modal fade" id="crearPrograma" tabindex="-1" aria-labelledby="createModalLabel"
                    aria-hidden="true">
                                ...
                                <form action="StoreProgramas" method="post">
                                    ...
                                    <p>
                                        <select name="idCurso">
                                            ...
                                            <c:forEach items="${cursosSinPrograma}" var="cursosSinPrograma">
                        ...
                        <c:forEach items="${programas}" var="programa">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn naranja btn-warning btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#verContenido${programa.curso.id}">visualizar</button>

                                    <div class="modal fade" id="verContenido${programa.curso.id}" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">
                                                        ${programa.curso.nivel} | ${programa.curso.turno}:
                                                    </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                ...
                                <td>
                                    ...
                                    <div class="modal fade" id="verCriterioEvaluacion${programa.curso.id}" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-light" data-bs-toggle="modal"
                                        data-bs-target="#verPrograma${programa.curso.id}">
                                    ...
                                    <div class="modal fade" id="verPrograma${programa.curso.id}" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <ul class="list-group list-group-flush">
                                                        <li class="list-group-item"><strong>Curso:</strong>
                                                            ${programa.curso.nivel}, ${programa.curso.turno}</li>
                                                        <li class="list-group-item"><strong>Contenido:</strong>
                                                            ${programa.contenido}</li>
                                                        <li class="list-group-item"><strong>Criterios:</strong>
                                                            ${programa.criterioEvaluacion}</li>
                                    ...
                                    <!-- boton editar -->
                                    <button type="button" class="btn btn-light" data-bs-toggle="modal"
                                        data-bs-target="#editarPrograma ${programa.curso.id}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                    ...
                                    <div class="modal fade" id="editarPrograma ${programa.curso.id}" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                     ...
                                     <!-- boton eliminar --> <a class="btn btn-light"
