			...
			<div class="container-fluid">
				...
				<div class="row">
					<nav class="navbar bg-dark navbar-expand-lg ">
						<div class="container-fluid">
							<a href="landingPage.jsp"><img src="imgs/logo-aek.png" width="30%" height="60%"
									alt="logo-aek"></a>
						</div>
					</nav>
				</div>
										...
										<form action="StoreSeguimientos" method="post">
											...
											<p>
												...
												<select name="idAlumno">
													...
													<c:forEach items="${alumnosSinSeguimiento}" var="alumnosSinSeguimiento">
														<option value="${alumnosSinSeguimiento.id}">${alumnosSinSeguimiento.id} | ${alumnosSinSeguimiento.nombre} | ${alumnosSinSeguimiento.apellido}</option>
													</c:forEach>
												</select>
											</p>
											<p>
										...
										<td>
											...
											<div class="modal fade" id="editarSeguimiento${seguimiento.alumno.id}"
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															<h5 class="modal-title" id="editarModal">Modificando alumno
																<strong>${seguimiento.alumno.id},
																	${seguimiento.alumno.dni},
																	${seguimiento.alumno.nombre}
																	${seguimiento.alumno.apellido}</strong></h5>
															<button type="button" class="btn-close"
																data-bs-dismiss="modal" aria-label="Close"></button>
														</div>
														<div class="modal-body">
