						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="StoreSeguimientos" method="post">
									...
									<p>
										Alumno: <input type="text" name="idAlumno" />
									</p>
									<p>
										Faltas: <input type="text" name="faltas" />
									</p>
									<p>
										Participacion: <input type="text" name="participacion" />
									</p>
									<p>
										Rendimiento: <input type="text" name="rendimiento" />
									</p>
				...
				<table class="table">
					...
					<tbody>
						...
						<c:forEach items="${seguimientos}" var="seguimiento">
							<tr>
								<td>${seguimiento.alumno.dni},${seguimiento.alumno.nombre}
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="UpdateSeguimientos" method="POST">
														...
														<input type="text" name="participacion"
															value="${seguimiento.participacion}" />
														<p class="mb-0">Rendimiento:</p>
														<input type="text" name="rendimiento"
															value="${seguimiento.rendimiento}" />
