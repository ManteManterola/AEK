            ...
            <div>
                ...
                <div class="row">
                    ...
                    <div class="col-10 mt-2">
                        ...
                        <!-- boton crear -->
                        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#crearSeguimiento">
                        ...
                        <div class="modal fade" id="crearSeguimiento" tabindex="-1" aria-labelledby="createModalLabel"
                            aria-hidden="true">
                                            ...
                                            <p>
                                                Alumno: <select name="idAlumno">
                                                    ...
                                                    <c:forEach items="${alumnosSinSeguimiento}"
                                                        ...
                                                        <option value="${alumnosSinSeguimiento.id}">
                                                            ${alumnosSinSeguimiento.id}
                                ...
                                <c:forEach items="${seguimientos}" var="seguimiento">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="verSeguimiento${seguimiento.alumno.id}"
                                            ...
                                            <div class="modal fade" id="editarSeguimiento${seguimiento.alumno.id}"
                                                tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="UpdateSeguimientos" method="POST">
                                                                ...
                                                                <p class="mb-0">Nota:</p>
                                                                <select name="nota">
                                                                    <option value=0 ${seguimiento.nota=='0' ? 'selected'
                                                                        : '' }>0</option>
                                                                    <option value=1 ${seguimiento.nota=='1' ? 'selected'
                                                                        : '' }>1</option>
                                                                    <option value=2 ${seguimiento.nota=='2' ? 'selected'
                                                                        : '' }>2</option>
                                                                    <option value=3 ${seguimiento.nota=='3' ? 'selected'
                                                                        : '' }>3</option>
                                                                    <option value=4 ${seguimiento.nota=='4' ? 'selected'
                                                                        : '' }>4</option>
                                                                    <option value=5 ${seguimiento.nota=='5' ? 'selected'
                                                                        : '' }>5</option>
                                                                    <option value=6 ${seguimiento.nota=='6' ? 'selected'
                                                                        : '' }>6</option>
                                                                    <option value=7 ${seguimiento.nota=='7' ? 'selected'
                                                                        : '' }>7</option>
                                                                    <option value=8 ${seguimiento.nota=='8' ? 'selected'
                                                                        : '' }>8</option>
                                                                    <option value=9 ${seguimiento.nota=='9' ? 'selected'
                                                                        : '' }>9</option>
                                                                    <option value=10 ${seguimiento.nota=='10'
                                                                        ? 'selected' : '' }>10</option>
                                                                </select>
